...
public class HeaderDominoSourceGenerator
    extends AbstractHeaderSourceGenerator {

  private HeaderDominoSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public HeaderDominoSourceGenerator build() {
      return new HeaderDominoSourceGenerator(this);
    }
  }
}
