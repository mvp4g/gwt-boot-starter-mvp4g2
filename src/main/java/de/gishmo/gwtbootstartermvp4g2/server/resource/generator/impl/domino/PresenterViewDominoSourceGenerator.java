...
public class PresenterViewDominoSourceGenerator
    extends AbstractPresenterViewSourceGenerator {

  private PresenterViewDominoSourceGenerator(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public PresenterViewDominoSourceGenerator build() {
      return new PresenterViewDominoSourceGenerator(this);
    }
  }
}
